...
public class WriteData {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException {
		...
		FileInputStream fis = new FileInputStream("./data/Sample.xlsx");// location where the file is stored
		Workbook wb = WorkbookFactory.create(fis);//create method is used to make the file ready for the write operation
		Sheet sh = wb.getSheet("login");//the sheet in which you want to write the data
